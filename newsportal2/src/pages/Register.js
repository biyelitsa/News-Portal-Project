...
export default function Register() {
    ...
    const submit = async (event) => {
        ...
        await fetch('http://localhost:5127/api/Authenticate/register', {
            method: 'POST',
    ...
    return (
        ...
        <form onSubmit={submit} >
            ...
            <input type="email" className="form-control" placeholder="Email address" required onChange={e => setEmail(e.target.value)} /><br/>
